...
# ╔═╡ ca661468-f54e-4728-906f-b12573ad568f
begin
	using FileWatching
	using PythonCall
end

# ╔═╡ 6de4ca49-c220-441e-b3cf-275822a1fb53
using PlutoUI

# ╔═╡ dc654a0b-7213-4405-82f8-d77de1dcd854
begin
	...
	t = @async begin
		while true 
			FileWatching.watch_file("mylib.py")
			importlib.reload(mylib)
		end
	end
end

# ╔═╡ 308cb73a-f91d-4e41-92e7-f825fdbbeaf4
begin
	mylib.f(4)
end
...
manifest_format = "2.0"
project_hash = "c5a8fe861d73869fe92abe3f4f91c57dbaf8b683"
